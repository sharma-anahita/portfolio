    ...
    >
      <div className={`max-w-6xl mx-auto transition-all duration-700 ease-out ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          {/* ── GitHub Card ── */}
          <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-50 p-6">
            {/* Header */}
            ...
            <div className="w-full">
              ...
              {!ghImgError ? (
                <img
                  ...
                  className={`w-full rounded transition-opacity duration-500 ${ghImgLoaded ? 'opacity-100' : 'opacity-0 absolute'}`}
