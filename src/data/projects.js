export const projects = [
  {
    ...
    live: null,
    description: `Built a Unix-like command-line shell in C supporting command parsing, built-in commands, and external program execution.`,
    highlights: [
  ...
  },
  {
    ...
    title: 'LogGPT — AI-Powered Log Parser & Anomaly Detector',
    technologies: [
      'Python',
      'OpenAI API',
      'FastAPI',
    ...
    github: 'https://github.com/sharma-anahita/logGPT',
    live: null,
    description: `Developed an intelligent log analysis and anomaly detection system using GPT models. LogGPT ingests raw system/application logs, parses them into structured templates, detects operational anomalies and security threats in real-time, and provides natural language root-cause analysis.`,
    highlights: [
      'Built an automated parsing pipeline utilizing regular expressions and pre-trained LLMs to map unstructured log entries to semantic event templates.',
      'Implemented sequence-based anomaly detection algorithms to flag suspicious event sequences and potential security breaches.',
      'Integrated OpenAI API to provide actionable, natural language explanations of system errors and security threats for system operators.',
      'Optimized log ingestion and processing speed, supporting batch parsing of large-scale log files with robust error handling.'
    ]
  },
  {
    image: '/api/placeholder/130/100',
